...
--dual                Applying dual supervision (True|False)
...
KBP (Bi-GRU)
```
python Neural/train.py --repeat 1 --dual True 
...
```
python Neural/train.py --model palstm --dual True --repeat 1 --info palstm_kbp --in_drop 0.5 --intra_drop 0.1 --out_drop 0.5
